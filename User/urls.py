...
urlpatterns = [
    ...
    path('lecturer/<int:id>/announcement/general/view-all', views.LecturerGeneralAnnouncementViewAll, name="lecturer-general-announcement-all"),
    path('lecturer/<int:id>/announcement/class/view-all', views.LecturerClassAnnouncementViewAll, name="lecturer-class-announcement-all"),
    ...
    path('lecturer/<int:id>/class/<int:class_id>/announcement/<int:class_announcement_id>', views.LecturerClassAnnouncementPage, name="lecturer-class-announcement-viewpage"),
    ...
    path('student/<int:id>/announcement/view-all', views.StudentGeneralAnnouncementViewAll, name="student-general-announcement-all"),
    path('student/<int:id>/announcement/class/view-all', views.StudentClassAnnouncementViewAll, name="student-class-announcement-all"),
    ...
    path('student/<int:id>/class/<int:class_id>/announcement/<int:class_announcement_id>', views.StudentClassAnnouncementPage, name="student-class-announcement-viewpage"),
